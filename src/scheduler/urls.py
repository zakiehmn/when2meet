...
urlpatterns = [
    ...
    path('<uuid:unique_id>/availibility/', AttendeeAvailibilityView.as_view(), name='create_availibility'),
    path('<uuid:unique_id>/', CreateEventView.as_view(), name='create-event')
]